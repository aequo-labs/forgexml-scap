...
- Editing all element types with form-based interfaces
- Validating documents against the schema
- Exporting to valid XML
...
2. Select the root element type from the dropdown
...
4. The document will be loaded and validated

### Exporting a Document

1. Go to the **Export** page
2. Review the XML preview
3. Click **Download XML** to save the file

### Validating a Document

The editor automatically validates documents against this XSD schema when:
- Importing XML files
- Exporting documents
- Using the validation API endpoint

## API Endpoints

| Endpoint | Method | Description |
|----------|--------|-------------|
| `/api/import` | POST | Import an XML file |
| `/api/export` | GET | Export current document as XML |
| `/api/validate` | POST | Validate XML against schema |
| `/api/tree/root` | GET | Get root element for tree view |
| `/api/tree/children` | GET | Get child elements for tree expansion |
