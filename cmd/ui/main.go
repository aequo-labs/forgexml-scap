...
// Source: /home/mmcnew/repos/forgexml-scap/schemas/cpe-dictionary/cpe-dictionary_2.1.xsd
// Schema: Dictionary 2.0
...
func main() {
	...
	if *showVersion {
		fmt.Printf("Dictionary 2.0 UI Editor\n")
	...
	srv.SetAboutInfo(webserver.AboutInfo{
		AppName:     "SCAP Editor",
		Version:     version,
		Description: "XML Editor for Dictionary 2.0 documents",
		Features: []string{
