...
// Source: /home/mmcnew/repos/forgexml-scap/schemas/oval/5.11.2/oval-definitions-schema.xsd
// Schema: Xmlschema
...
func main() {
	...
	if *showVersion {
		fmt.Printf("Xmlschema UI Editor\n")
	...
	srv.SetAboutInfo(webserver.AboutInfo{
		AppName:     "Xmlschema Editor",
		Version:     version,
		Description: "XML Editor for Xmlschema documents",
		Features: []string{
	...
	log.Printf("Starting Xmlschema Editor on port %d", *port)
