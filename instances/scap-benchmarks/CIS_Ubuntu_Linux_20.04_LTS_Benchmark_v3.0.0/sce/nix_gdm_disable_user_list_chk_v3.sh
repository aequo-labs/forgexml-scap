...
# -------------------------------------------------------------------
# R. Bejar     02/12/25   SCE Ensure GDM disable-user-list option is enabled

# supersedes nix_gdm_disable_user_list_chk.sh and nix_gdm_disable_user_list_chk_v2.sh
