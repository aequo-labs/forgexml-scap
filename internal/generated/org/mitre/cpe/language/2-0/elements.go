...
func (e *PlatformSpecificationElement) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
...
func (e *PlatformSpecificationElement) MarshalXML(encoder *xml.Encoder, start xml.StartElement) error {
...
func (e *PlatformSpecificationElement) MarshalIndentClean(prefix, indent string) ([]byte, error) {
...
func (e *PlatformSpecificationElement) ToBytes() ([]byte, error) {
...
func (e *PlatformSpecificationElement) SetElementPrefixes(prefixes map[string]string) {
...
func (e *PlatformSpecificationElement) SetElementsWithXmlns(elementsWithXmlns map[string]string) {
	e.elementsWithXmlns = elementsWithXmlns
}

// SaveToFile saves the element to a file with namespace preservation
func (e *PlatformSpecificationElement) SaveToFile(path string) error {
	data, err := e.ToBytes()
	if err != nil {
		return err
	}
...
func LoadPlatformSpecificationFromBytes(data []byte) (*PlatformSpecificationElement, error) {
...
func LoadPlatformSpecificationFromFile(path string) (*PlatformSpecificationElement, error) {
	data, err := os.ReadFile(path)
	if err != nil {
		return nil, err
	}
	return LoadPlatformSpecificationFromBytes(data)
}
