// Package xmlschemaoval_definitions_5_freebsd generated from XSD schema
// Source namespace: http://oval.mitre.org/XMLSchema/oval-definitions-5#freebsd
// Source XSD file: /home/mmcnew/repos/forgexml-scap/schemas/oval/5.11.2/freebsd-definitions-schema.xsd
...
type Portinfo_testElement struct {
	XMLName                              xml.Name `xml:"http://oval.mitre.org/XMLSchema/oval-definitions-5#freebsd portinfo_test"`
...
func (e *Portinfo_testElement) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	// Create alias type to prevent recursion
	type alias Portinfo_testElement
	aux := (*alias)(e)
...
func (e *Portinfo_testElement) MarshalXML(encoder *xml.Encoder, start xml.StartElement) error {
...
func (e *Portinfo_testElement) MarshalIndentClean(prefix, indent string) ([]byte, error) {
...
func (e *Portinfo_testElement) ToBytes() ([]byte, error) {
...
func (e *Portinfo_testElement) SetElementPrefixes(prefixes map[string]string) {
...
func (e *Portinfo_testElement) SetElementsWithXmlns(elementsWithXmlns map[string]string) {
	e.elementsWithXmlns = elementsWithXmlns
}

// SaveToFile saves the element to a file with namespace preservation
func (e *Portinfo_testElement) SaveToFile(path string) error {
	data, err := e.ToBytes()
	if err != nil {
		return err
	}
...
// LoadPortinfo_testFromBytes loads an element from bytes with namespace preservation
func LoadPortinfo_testFromBytes(data []byte) (*Portinfo_testElement, error) {
	...
	var element Portinfo_testElement
...
// LoadPortinfo_testFromFile loads an element from a file with namespace preservation
func LoadPortinfo_testFromFile(path string) (*Portinfo_testElement, error) {
	data, err := os.ReadFile(path)
	if err != nil {
		return nil, err
	}
	return LoadPortinfo_testFromBytes(data)
}
...
// UnmarshalXML implements custom unmarshaling with namespace preservation
func (e *Portinfo_objectElement) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	// Create alias type to prevent recursion
	type alias Portinfo_objectElement
	aux := (*alias)(e)
...
// MarshalXML implements custom marshaling with namespace preservation
func (e *Portinfo_objectElement) MarshalXML(encoder *xml.Encoder, start xml.StartElement) error {
	// Use the struct's XMLName to ensure correct element name
	start.Name = e.XMLName
...
// This method: 1) Fixes Go's xmlns corruption, 2) Restores element prefixes
// Preserves legitimate xmlns on nested elements with different default namespaces
func (e *Portinfo_objectElement) MarshalIndentClean(prefix, indent string) ([]byte, error) {
	data, err := xml.MarshalIndent(e, prefix, indent)
	if err != nil {
		return nil, err
	}
...
// ToBytes marshals the element to bytes with namespace preservation
// This is the recommended method for serializing to XML with round-trip fidelity
func (e *Portinfo_objectElement) ToBytes() ([]byte, error) {
	return e.MarshalIndentClean("", "  ")
}

// SetElementPrefixes allows injecting element prefix mappings from raw XML
// This is typically called after unmarshal with ExtractElementPrefixes(rawXML)
func (e *Portinfo_objectElement) SetElementPrefixes(prefixes map[string]string) {
	e.elementPrefixes = prefixes
}
...
// This is typically called after unmarshal with ExtractElementsWithXmlns(rawXML)
// for perfect xmlns fidelity (zero xmlns delta)
func (e *Portinfo_objectElement) SetElementsWithXmlns(elementsWithXmlns map[string]string) {
	e.elementsWithXmlns = elementsWithXmlns
}

// SaveToFile saves the element to a file with namespace preservation
func (e *Portinfo_objectElement) SaveToFile(path string) error {
	data, err := e.ToBytes()
	if err != nil {
		return err
	}
...
// LoadPortinfo_objectFromBytes loads an element from bytes with namespace preservation
func LoadPortinfo_objectFromBytes(data []byte) (*Portinfo_objectElement, error) {
	// Extract element prefixes from raw XML before unmarshaling
	elementPrefixes := ExtractElementPrefixes(data)
	// Extract which elements had xmlns for exact xmlns replication
	elementsWithXmlns := ExtractElementsWithXmlns(data)

	var element Portinfo_objectElement
	if err := xml.Unmarshal(data, &element); err != nil {
		return nil, err
	}
...
// LoadPortinfo_objectFromFile loads an element from a file with namespace preservation
func LoadPortinfo_objectFromFile(path string) (*Portinfo_objectElement, error) {
	data, err := os.ReadFile(path)
	if err != nil {
		return nil, err
	}
	return LoadPortinfo_objectFromBytes(data)
}

// Portinfo_stateElement represents the XSD element 'portinfo_state'
// XSD element declaration (W3C XSD §3.3)
type Portinfo_stateElement struct {
	XMLName                               xml.Name `xml:"http://oval.mitre.org/XMLSchema/oval-definitions-5#freebsd portinfo_state"`
...
// UnmarshalXML implements custom unmarshaling with namespace preservation
func (e *Portinfo_stateElement) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	// Create alias type to prevent recursion
	type alias Portinfo_stateElement
	aux := (*alias)(e)
...
// MarshalXML implements custom marshaling with namespace preservation
func (e *Portinfo_stateElement) MarshalXML(encoder *xml.Encoder, start xml.StartElement) error {
	// Use the struct's XMLName to ensure correct element name
	start.Name = e.XMLName
...
// This method: 1) Fixes Go's xmlns corruption, 2) Restores element prefixes
// Preserves legitimate xmlns on nested elements with different default namespaces
func (e *Portinfo_stateElement) MarshalIndentClean(prefix, indent string) ([]byte, error) {
	data, err := xml.MarshalIndent(e, prefix, indent)
	if err != nil {
		return nil, err
	}
...
// ToBytes marshals the element to bytes with namespace preservation
// This is the recommended method for serializing to XML with round-trip fidelity
func (e *Portinfo_stateElement) ToBytes() ([]byte, error) {
	return e.MarshalIndentClean("", "  ")
}

// SetElementPrefixes allows injecting element prefix mappings from raw XML
// This is typically called after unmarshal with ExtractElementPrefixes(rawXML)
func (e *Portinfo_stateElement) SetElementPrefixes(prefixes map[string]string) {
	e.elementPrefixes = prefixes
}
...
// This is typically called after unmarshal with ExtractElementsWithXmlns(rawXML)
// for perfect xmlns fidelity (zero xmlns delta)
func (e *Portinfo_stateElement) SetElementsWithXmlns(elementsWithXmlns map[string]string) {
	e.elementsWithXmlns = elementsWithXmlns
}

// SaveToFile saves the element to a file with namespace preservation
func (e *Portinfo_stateElement) SaveToFile(path string) error {
	data, err := e.ToBytes()
	if err != nil {
		return err
	}
...
// LoadPortinfo_stateFromBytes loads an element from bytes with namespace preservation
func LoadPortinfo_stateFromBytes(data []byte) (*Portinfo_stateElement, error) {
	// Extract element prefixes from raw XML before unmarshaling
	elementPrefixes := ExtractElementPrefixes(data)
	// Extract which elements had xmlns for exact xmlns replication
	elementsWithXmlns := ExtractElementsWithXmlns(data)

	var element Portinfo_stateElement
	if err := xml.Unmarshal(data, &element); err != nil {
		return nil, err
	}
...
// LoadPortinfo_stateFromFile loads an element from a file with namespace preservation
func LoadPortinfo_stateFromFile(path string) (*Portinfo_stateElement, error) {
	data, err := os.ReadFile(path)
	if err != nil {
		return nil, err
	}
	return LoadPortinfo_stateFromBytes(data)
}
