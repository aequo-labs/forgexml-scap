// Package xmlschemaoval_directives_5 generated from XSD schema
// Source namespace: http://oval.mitre.org/XMLSchema/oval-directives-5
// Source XSD file: /home/mmcnew/repos/forgexml-scap/schemas/oval/5.11.2/oval-directives-schema.xsd
...
// Oval_directivesElement represents the XSD element 'oval_directives'
...
type Oval_directivesElement struct {
	...
	Class_directives []xmlschemaoval_results_5.ClassDirectivesType `xml:"class_directives,omitempty"`
...
func (e *Oval_directivesElement) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	// Create alias type to prevent recursion
	type alias Oval_directivesElement
	aux := (*alias)(e)
...
func (e *Oval_directivesElement) MarshalXML(encoder *xml.Encoder, start xml.StartElement) error {
...
func (e *Oval_directivesElement) MarshalIndentClean(prefix, indent string) ([]byte, error) {
...
func (e *Oval_directivesElement) ToBytes() ([]byte, error) {
...
func (e *Oval_directivesElement) SetElementPrefixes(prefixes map[string]string) {
...
func (e *Oval_directivesElement) SetElementsWithXmlns(elementsWithXmlns map[string]string) {
	e.elementsWithXmlns = elementsWithXmlns
}

// SaveToFile saves the element to a file with namespace preservation
func (e *Oval_directivesElement) SaveToFile(path string) error {
	data, err := e.ToBytes()
	if err != nil {
		return err
	}
...
// LoadOval_directivesFromBytes loads an element from bytes with namespace preservation
func LoadOval_directivesFromBytes(data []byte) (*Oval_directivesElement, error) {
	...
	var element Oval_directivesElement
...
// LoadOval_directivesFromFile loads an element from a file with namespace preservation
func LoadOval_directivesFromFile(path string) (*Oval_directivesElement, error) {
	data, err := os.ReadFile(path)
	if err != nil {
		return nil, err
	}
	return LoadOval_directivesFromBytes(data)
}
