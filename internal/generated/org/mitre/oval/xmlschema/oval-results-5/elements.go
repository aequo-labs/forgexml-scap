...
// Oval_resultsElement represents the XSD element 'oval_results'
// XSD element declaration (W3C XSD §3.3)
type Oval_resultsElement struct {
	XMLName xml.Name `xml:"http://oval.mitre.org/XMLSchema/oval-results-5 oval_results"`
...
func (e *Oval_resultsElement) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	// Create alias type to prevent recursion
	type alias Oval_resultsElement
	aux := (*alias)(e)
...
func (e *Oval_resultsElement) MarshalXML(encoder *xml.Encoder, start xml.StartElement) error {
...
func (e *Oval_resultsElement) MarshalIndentClean(prefix, indent string) ([]byte, error) {
...
func (e *Oval_resultsElement) ToBytes() ([]byte, error) {
...
func (e *Oval_resultsElement) SetElementPrefixes(prefixes map[string]string) {
...
func (e *Oval_resultsElement) SetElementsWithXmlns(elementsWithXmlns map[string]string) {
	e.elementsWithXmlns = elementsWithXmlns
}

// SaveToFile saves the element to a file with namespace preservation
func (e *Oval_resultsElement) SaveToFile(path string) error {
	data, err := e.ToBytes()
	if err != nil {
		return err
	}
...
// LoadOval_resultsFromBytes loads an element from bytes with namespace preservation
func LoadOval_resultsFromBytes(data []byte) (*Oval_resultsElement, error) {
	...
	var element Oval_resultsElement
...
// LoadOval_resultsFromFile loads an element from a file with namespace preservation
func LoadOval_resultsFromFile(path string) (*Oval_resultsElement, error) {
	data, err := os.ReadFile(path)
	if err != nil {
		return nil, err
	}
	return LoadOval_resultsFromBytes(data)
}
