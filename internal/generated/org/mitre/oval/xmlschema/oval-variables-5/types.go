...
type VariablesType struct {
	// Variable represents XSD element 'variable'
...
type VariableType struct {
	...
	// Instance represents XSD attribute 'instance'
	// use="optional"
	Instance *uint64 `xml:"instance,attr,omitempty"`
...
// Oval_variablesElementType represents the XSD type 'Oval_variablesElementType'
// XSD complex type (W3C XSD §3.4)
type Oval_variablesElementType struct {
