// Package xmlschemaovaldievalids - Marshal/Unmarshal Tests
...
// TestEvalutationDefinitionIdsElement_MarshalUnmarshal tests XML round-trip for EvalutationDefinitionIdsElement
func TestEvalutationDefinitionIdsElement_MarshalUnmarshal(t *testing.T) {
	original := &EvalutationDefinitionIdsElement{
		XMLName: xml.Name{Space: "http://oval.mitre.org/XMLSchema/ovaldi/evalids", Local: "evalutation-definition-ids"},
	}
	...
	// Unmarshal back
	var decoded EvalutationDefinitionIdsElement
...
// TestEvalutationDefinitionIdsElement_MarshalIndentClean tests the MarshalIndentClean method
func TestEvalutationDefinitionIdsElement_MarshalIndentClean(t *testing.T) {
	elem := &EvalutationDefinitionIdsElement{
		XMLName: xml.Name{Space: "http://oval.mitre.org/XMLSchema/ovaldi/evalids", Local: "evalutation-definition-ids"},
	}
...
// TestEvalutationDefinitionIdsElement_ToBytes tests the ToBytes method
func TestEvalutationDefinitionIdsElement_ToBytes(t *testing.T) {
	elem := &EvalutationDefinitionIdsElement{
		XMLName: xml.Name{Space: "http://oval.mitre.org/XMLSchema/ovaldi/evalids", Local: "evalutation-definition-ids"},
	}
...
// TestEvalutationDefinitionIdsElement_SetElementPrefixes tests the SetElementPrefixes method
func TestEvalutationDefinitionIdsElement_SetElementPrefixes(t *testing.T) {
	elem := &EvalutationDefinitionIdsElement{
		XMLName: xml.Name{Space: "http://oval.mitre.org/XMLSchema/ovaldi/evalids", Local: "evalutation-definition-ids"},
	}
...
// TestEvalutationDefinitionIdsElement_SetElementsWithXmlns tests the SetElementsWithXmlns method
func TestEvalutationDefinitionIdsElement_SetElementsWithXmlns(t *testing.T) {
	elem := &EvalutationDefinitionIdsElement{
		XMLName: xml.Name{Space: "http://oval.mitre.org/XMLSchema/ovaldi/evalids", Local: "evalutation-definition-ids"},
	}
...
// TestEvalutationDefinitionIdsElement_SaveAndLoad tests SaveToFile and LoadEvalutationDefinitionIdsFromFile
func TestEvalutationDefinitionIdsElement_SaveAndLoad(t *testing.T) {
	elem := &EvalutationDefinitionIdsElement{
		XMLName: xml.Name{Space: "http://oval.mitre.org/XMLSchema/ovaldi/evalids", Local: "evalutation-definition-ids"},
	}
	...
	// Load from file
	loaded, err := LoadEvalutationDefinitionIdsFromFile(tmpFile)
	if err != nil {
...
// TestEvalutationDefinitionIdsElement_LoadFromBytes tests the LoadEvalutationDefinitionIdsFromBytes function
func TestEvalutationDefinitionIdsElement_LoadFromBytes(t *testing.T) {
	xmlData := []byte(`<evalutation-definition-ids xmlns="http://oval.mitre.org/XMLSchema/ovaldi/evalids"></evalutation-definition-ids>`)

	loaded, err := LoadEvalutationDefinitionIdsFromBytes(xmlData)
	if err != nil {
...
// TestEvalutationDefinitionIdsElementType_MarshalUnmarshal tests XML round-trip for EvalutationDefinitionIdsElementType
func TestEvalutationDefinitionIdsElementType_MarshalUnmarshal(t *testing.T) {
	original := &EvalutationDefinitionIdsElementType{}
	...
	// Unmarshal back
	var decoded EvalutationDefinitionIdsElementType
	if err := xml.Unmarshal(xmlData, &decoded); err != nil {
		t.Fatalf("Unmarshal failed: %v", err)
	}
